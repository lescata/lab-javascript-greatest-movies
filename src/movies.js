...
function dramaMoviesScore(movies) {
  ...
  let isDrama = movies.filter(function(el2){
    return el2.genre.includes("Drama");
    });
    let  dramaScore = isDrama.reduce(function(accumulator,msc){
      return (accumulator +msc.score);
    },0)
